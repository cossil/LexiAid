      ...
      <main className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <article>
          ...
          <ul className={`list-disc pl-6 ${highContrast ? 'text-gray-100' : 'text-gray-300'} space-y-4 mb-6 text-lg`}>
            <li onMouseEnter={() => handleHover('We Make Documents Speak: Our "Document Understanding Agent" doesn\'t just read text; it analyzes the entire page. It describes charts, explains images in context, and navigates layout complexities, turning a static PDF into an interactive, narrated experience.')}>
