      ...
      <main className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <article>
          ...
          <ul className={`list-disc pl-6 ${highContrast ? 'text-gray-100' : 'text-gray-300'} space-y-4 mb-6 text-lg`}>
            <li onMouseEnter={() => handleHover('Account Security: You are responsible for maintaining the confidentiality of your login information.')}>
            ...
            <li onMouseEnter={() => handleHover('Content: You agree not to upload content that is illegal, harmful, or violates the copyright of others. You retain ownership of the documents you upload.')}>
