...
class TTSService:
    ...
    def synthesize_text(self, text, voice_name=None, speaking_rate=None, pitch=None,
        ...
        final_voice_name = voice_name if voice_name is not None else os.getenv('TTS_DEFAULT_VOICE_NAME', "en-US-Chirp3-HD-Leda")
        
        # DEBUG: Log exactly what voice is being used
        print(f"DEBUG TTS: voice_name param={voice_name}, env TTS_DEFAULT_VOICE_NAME={os.getenv('TTS_DEFAULT_VOICE_NAME')}, final_voice_name={final_voice_name}", flush=True)
        try:
